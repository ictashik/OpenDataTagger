...
urlpatterns = [
    ...
    path(f'{BASE_URL}/connection/capability/',     views.llm_capability_view,         name='llm_capability'),
    path(f'{BASE_URL}/connection/models/',         views.llm_models_view,             name='llm_models'),
    path(f'{BASE_URL}/connection/models/download/', views.llm_model_download_view,    name='llm_model_download'),
    path(f'{BASE_URL}/connection/models/download/status/', views.llm_model_download_status_view, name='llm_model_download_status'),
    path(f'{BASE_URL}/connection/models/delete/',  views.llm_model_delete_view,       name='llm_model_delete'),
